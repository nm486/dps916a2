...
@Using Html.BeginForm()
    ...
    @<fieldset>
        ...
        @Html.HiddenFor(Function(model) model.PhoneNumberId)
        ...
        <br /> All that is required are the numbers - no special characters or spaces needed.  Phone numbers are automatically formatted.
        <p>
