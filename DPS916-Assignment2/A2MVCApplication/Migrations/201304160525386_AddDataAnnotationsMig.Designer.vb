...
Namespace Migrations
    Public NotInheritable Partial Class AddDataAnnotationsMig
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddDataAnnotationsMig))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201304160525386_AddDataAnnotationsMig"
            End Get
        End Property
